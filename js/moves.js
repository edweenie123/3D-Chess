class Moves {
  ...
  addMove(pieceId, info, colour, curRow, curCol, curLvl, newRow, newCol, newLvl) {
	  ...
	  var movement = "<img src=\"3D-Chess/img/" + imgFileName + "\" width=\"20px\">" + String.fromCharCode('A'.charCodeAt(0) + curLvl) + String.fromCharCode('a'.charCodeAt(0) + curCol) + (1 + curRow) + (info.capturedPiece ? "x" : " ") + String.fromCharCode('A'.charCodeAt(0) + newLvl) + String.fromCharCode('a'.charCodeAt(0) + newCol) + (1 + newRow); 
