class Board {
  ...
  handleSfx(moveInfo) {
    ...
    if (moveInfo.enemyMated || moveInfo.isStalemate)
      sound = new Audio("3D-Chess/sfx/game-end.wav");
    else if (moveInfo.enemyChecked) sound = new Audio("3D-Chess/sfx/move-check.wav");
    else if (moveInfo.capturedPiece) sound = new Audio("3D-Chess/sfx/capture.wav");
    // normal move sound effect
    else sound = new Audio("3D-Chess/sfx/move-self.wav");
  ...
  promote(row, col, lvl, promoteId) {
    ...
    var promote = new Audio("3D-Chess/sfx/promote.wav");
    promote.play();
